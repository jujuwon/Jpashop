...
import com.jujuwon.book.springboot.config.auth.dto.OAuthAttributes;
import com.jujuwon.book.springboot.config.auth.dto.SessionUser;
import com.jujuwon.book.springboot.domain.user.User;
import com.jujuwon.book.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		//OAuth2 로그인 진행 시 키가 되는 필드값. 구글은 기본 지원하지만, 네이버 카카오 등은 기본 지원하지 않음.
		//구글의 기본 코드는 sub
